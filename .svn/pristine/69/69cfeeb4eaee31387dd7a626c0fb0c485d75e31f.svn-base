package com.rubenswieringa.book {
	...
	import com.rubenswieringa.drawing.DrawingTool;
	import com.rubenswieringa.geom.Geom;
	import com.rubenswieringa.geom.Line;
	import com.rubenswieringa.geom.SuperRectangle;
	import com.rubenswieringa.utils.ArrayTool;
	...
	public class Gradients {
		 ...
		 * @private
		 */
		protected var _solidColorAlpha:Number = 1;
