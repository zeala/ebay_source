package com.ebayproject.components.panels {
	...
	public class CustomTitleWindow extends TitleWindow {
		...
		[SkinPart(required="false")]
		public var interactiveTitleElements : Group;
		...
		override protected function partAdded(partName:String, instance:Object):void {
			...
			if ( instance == closeButton )
			{
				...
				this.addEventListener(CloseEvent.CLOSE, closeSelf );
			}
			
			if ( instance == interactiveTitleElements )
			{
				trace("\n interactiveGroupAdded " );
			}
		}
		
		private function closeSelf( event : CloseEvent ):void
		{
